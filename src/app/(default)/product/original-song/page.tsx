...
export default function OriginalSong() {
  ...
  return (
    <>
      <SEO
        title="Original Song"
        description="Get a custom, original song created just for you by professional artists"
      />
            ...
            <div className="border-t pt-6 space-y-4">
              ...
              <ol className="space-y-4 list-decimal list-inside text-gray-600">
                ...
                <li>
                  ...
                  and details. You&apos;ll be amazed at how easily it all
                  unfolds!
                </li>
                <li>
                  Finally, your selected artist will take the reins,
                  transforming your story and vision into a one-of-a-kind custom
                  song.
                </li>
                <li>
                  Head over to your personal song page to listen, read the
                  lyrics, learn about the artist, and easily share with friends
                  and family to comment and join in the experience!
                </li>
              </ol>
            </div>
